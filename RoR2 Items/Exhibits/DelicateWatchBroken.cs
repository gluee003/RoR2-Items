...
{
    public sealed class DelicateWatchBrokenDef : ExhibitTemplate
    {
        public override IdContainer GetId()
        {
            return nameof(DelicateWatchBroken);
        }
    ...
    [EntityLogic(typeof(DelicateWatchBrokenDef))]
    public sealed class DelicateWatchBroken : Item
    {
    }
}
